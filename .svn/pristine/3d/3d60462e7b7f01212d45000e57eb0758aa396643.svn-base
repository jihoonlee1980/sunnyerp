...
@Controller
public class ComulistController {
			...
			)
	{
		...
		List<ComuDTO> list=cdao.getList(startNum, perPage);
		...
		{
			dto.setNick(cdao.getComuNick(dto.getSeq()));
		}
		
		model.setViewName("/1/community/comulist");
		return model;
	}
