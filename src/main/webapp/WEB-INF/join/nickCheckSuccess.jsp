...
snsArray['google'] = "https://plus.google.com/share?url=" + encodeURIComponent(strURL) + "&t=" + encodeURIComponent(strTitle);
	...
	<form action="joinForm.do" method="post">
		<table class="table">
			<tr>
				<th>
					<b style="color:gray"><b style="color:lime">'${m_nick}'</b>&nbsp; 는 사용 가능한 닉네임 입니다.</b><br><br>
					<input type="button" value="사용하기" id="useNick" m_nick="${m_nick}" class="btn btn-info" style="color:white">&nbsp;
					<input type="button" value="다시입력" onclick="location.href='nickCheckForm.do'" class="btn btn-warning" style="color:white">
				</th>
			</tr>
		</table>
	</form>
