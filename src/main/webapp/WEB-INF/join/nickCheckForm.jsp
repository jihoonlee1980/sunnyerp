...
<center>
	...
	<form action="nickCheck.do" method="post" onsubmit="return check(this)">
		<table class="table">
			<tr>
				<th>
					<b style="color:gray">닉네임(NICKNAME) 을 입력해주세요!</b>
					<br>
					<!-- <b style="color:gray">NICKNAME : </b> -->
					<br>
					<input type="text" name="m_nick" required="required"  autofocus="autofocus" class="form-control">
					<br>
					<input type="submit" value="중복 체크" class="btn btn-info" style="color:white">
