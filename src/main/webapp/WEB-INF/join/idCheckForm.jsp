...
snsArray['google'] = "https://plus.google.com/share?url=" + encodeURIComponent(strURL) + "&t=" + encodeURIComponent(strTitle);
	...
	<form action="idCheck.do" method="post" onsubmit="return check(this)">
		<table class="table">
			<tr>
				<th>
					<b style="color: gray;">아이디(ID) 를 입력해주세요!</b><br><br>
					<input type="text" name="m_id" required="required"  autofocus="autofocus" class="form-control">
					<br>
					<input type="submit" value="ID 중복 체크" class="btn btn-info">
					<input type="button" value="취소" class="btn btn-warning" onclick="window.close()">
				</th>
			</tr>
		</table>
	</form>	
