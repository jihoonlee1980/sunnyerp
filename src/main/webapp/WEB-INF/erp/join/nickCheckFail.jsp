...
snsArray['google'] = "https://plus.google.com/share?url=" + encodeURIComponent(strURL) + "&t=" + encodeURIComponent(strTitle);
	...
	<table class="table">
		<tr>
			<th>
				<b style="color:gray"><b style="color:lime">'${m_nick}'</b> &nbsp;는 사용중인 닉네임입니다.</b><br><br>
				<input type="button" value="다시입력" class="btn btn-info" onclick="location.href='nickCheckForm.do'">&nbsp;
			</th>
		</tr>
	</table>
