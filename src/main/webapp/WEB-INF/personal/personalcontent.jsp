...
<br><br>
	...
	<center>
		...
		<tr>
		<td align="center"><b style="color: gray;">작성일자(Date)</b></td>
				<td align="center">
		...
		<b style="color: lime;">${m_nick}</b>
					...
					<b style="color: orange;">${dto.gender}</b>
				...
				<b style="color: orange;">${dto.address}</b>
				...
				<td align="center">
					...
					<b style="color: blue;">${dto.hp}</b><br>
				...
				<td align="center">
					...
					<b style="color: blue;">${dto.email}</b><br>
				...
				<td align="center">
					...
					<b style="color: blue;">${dto.grade}</b><br>
					</td></tr>
				...
				<td align="center">
					...
					<b style="color: blue;">${dto.department}</b><br>
