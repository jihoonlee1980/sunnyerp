...
<c:if test="${sessionScope.m_id_.equals(sessionScope.m_id_)}">
		...
		<input type="text" name="gender" id="gender" class="form-control" required="required" placeholder="직접입력 또는 성별선택">
 		 ...
 		 <tr>
 		  ...
 		  <tr>
 		 	...
 		 	<td align="center">
 		 		...
 		 		placeholder="예 ) sunnyfactory@factorysunny.com">
 		 	</td>
 		 </tr>  		 
 		  <tr>
 		 ...
 		 <tr>
 		 	...
 		 	<td align="center">
 		 		<input type="text" name="sellvendor" id="sellvendo" required="required" class="form-control"
 		 		placeholder="직접입력 또는 공급처 새창에서 선택">
 		 	</td>
 		 </tr>
 		 <tr>
 		 	...
 		 	<td align="center">
 		 		...
 		 		placeholder="직접입력 또는 발주처 새창에서 선택">
 		 	</td>
 		 </tr>
 		 <tr>
 		 	...
 		 	<td align="center">
 		 		...
 		 		placeholder="직접입력 또는 수급처 새창에서 선택">
 		 	</td>
 		 </tr>
