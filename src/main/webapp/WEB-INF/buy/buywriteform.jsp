	...
	function check(f){
		...
		function check(f)
		{
			...
			if(f.buyvendor.value==''){
				alert("발주처를 입력 또는 선택해 주세요");
				return false;
			}
			if(f.productvendor.value==''){
...
<c:if test="${sessionScope.m_id_.equals(sessionScope.m_id_)}">
		...
		<input type="text" name="gender" id="gender" class="form-control" required="required" placeholder="직접입력 또는 성별선택">
 		   ...
 		   <tr>
 		 	...
 		 	<td align="center">
 		 		...
 		 		placeholder="협력사코드 정보에서 선택 (*리스트박스 연계/구현)">
 		 	</td>
 		 </tr>
			<tr>
 		 	...
 		 	<td align="center">
 		 		...
 		 		placeholder="발주 (*코드번호 채번 또는 기존 발주코드 사용)">
 		 	</td>
 		 </tr>
 		 <tr>
 		 	...
 		 	<td align="center">
 		 		...
 		 		placeholder="협력사 정보에서 선택 (*리스트박스 연계/구현)">
 		 	</td>
 		 </tr>
 		 <tr>
 		  ...
 		  <tr>
 		 	...
 		 	<td align="center">
 		 		...
 		 		placeholder="품목코드 정보에서 선택 (*리스트박스 연계/구현)">
 		 	</td>
 		 </tr>  		 
 		  <tr>
 		 	...
 		 	<td align="center">
 		 		...
 		 		placeholder="품목코드 정보에서 선택 또는 직접입력 (*리스트박스 연계/구현)">
 		 	</td>
 		 </tr>
 		 <tr>
 		 ...
 		 <tr>
 		 	...
 		 	<td align="center">
 		 		...
 		 		placeholder="단위 정보에서 선택 또는 직접입력 (*리스트박스 연계/구현)">
 		 	</td>
 		 </tr>
 		 <tr>
 		 	...
 		 	<td align="center">
 		 		...
 		 		placeholder="단가 정보에서 선택 또는 직접입력 (*리스트박스 연계/구현)">
 		 	</td>
 		 </tr>
 		 <tr>
 		 	...
 		 	<td align="center">
 		 		...
 		 		placeholder="발주금액 자동계산 (발주수량*발주단가)">
 		 	</td>
 		 </tr>
 		 <tr>
		...
		<input type="text" name="category" id="category" class="form-control" required="required" placeholder="직접입력 또는 분류선택">
         ...
         <%-- <tr>
         <td align="center"><b style="color: gray;"></b></td>
         	<td align="center">
