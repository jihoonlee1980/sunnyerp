			...
			<td align="center"><b style="color: gray;">실행</b></td>
				<td align="center"> -->
					...
					<%--  <c:if test="${sessionScope.m_id_.equals(sessionScope.m_id_)}"> --%>
					 ...
					 onclick="location.href='buyboardupdatepassform.do?num=${dto.num}&pageNum=${pageNum}'">
					 <input type="button" value="삭제"  class="btn btn-danger btn-sm"
					 onclick="location.href='buyboarddeletepassform.do?num=${dto.num}&pageNum=${pageNum}'">
					  </c:if>
				<!-- </td>
