...
<center>
	...
	<c:if test="${sessionScope.m_id_.equals(sessionScope.m_id_)}">
	  ...
	  <form action="update.do" method="post"> 
		<table id="comuupdatepass" class="table table-bordered">
			<%-- <caption style="text-align: center;"><b style="color: gray;">[ Community ]</b></caption><br> --%>
			<tr>
				
				
				<td align="center"><b style="color: gray;">작성자(Name)</b>
	 		 	
	 		 		<input type="text" name="m_nick" class="form-control" value="${sessionScope.m_id_}" readonly="readonly">
	 		 	</td>
			</tr>
			<tr>
				
	 		 	<td align="center"><b style="color: gray;">제목(Title)</b>
	 		 
	 		 		<input type="text" name="b_title" class="form-control" required="required" value="${cdto.b_title}">
	 		 	</td>
			</tr>
			<tr>
				<td align="center">
	 		 		<textarea name="b_content" rows="5" cols="25" style="color: gray;">${cdto.b_content}</textarea>
	 		 	</td>
			</tr>
			...
			<tr>
				...
				<input type="hidden" name="b_seq" value="${b_seq}">
					...
					<input type="button" class="btn btn-warning" value="목록" onclick="location.href='communitylist.do'">
