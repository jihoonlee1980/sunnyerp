...
snsArray['google'] = "https://plus.google.com/share?url=" + encodeURIComponent(strURL) + "&t=" + encodeURIComponent(strTitle);
	...
	<img class="img-responsive" src="${root}/save/images/slider/1600bg2.JPG" alt="logo">
...
<center>
	...
	<c:if test="${sessionScope.m_id_.equals(sessionScope.m_id_)}">
	  ...
	  <form action="comuupload.do" method="post"> 
		<table id="comuform" class="table table-bordered">
			...
			<tr>
				<td align="center">
	 		 		<textarea name="b_content" rows="5" cols="25" style="color: gray;"></textarea>
	 		 	</td>
			</tr>
