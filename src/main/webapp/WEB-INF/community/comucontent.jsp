...
snsArray['google'] = "https://plus.google.com/share?url=" + encodeURIComponent(strURL) + "&t=" + encodeURIComponent(strTitle);
	...
	<br>	
	    ...
	    <center>
			...
			<pre style="font-size: 10pt;white-space:pre-wrap;
 word-wrap:break-word;">
					<b style="color: orange;"> <b style="color: brown;">${cdto.b_title}</b></b></pre>
				 ...
				 <center>
					...
					<b style="color: orange;">작성자 : <b style="color: blue;">${m_nick}</b></b><br><br>
					
			
				<hr>
				
						 <a style="color: gray;">
					<fmt:formatDate value="${cdto.b_date}" pattern="yyyy-MM-dd HH:mm:ss"/>
						</a>
					...
					<b style="color: black;">조회&nbsp;<b style="color: red;">[${cdto.b_readcount}]</b></b><br><br>
			...
			<tr>
				<td style="text-align: center;">
					<input type="button" value="글쓰기"  class="btn btn-primary"
					 ...
					 <c:if test="${sessionScope.m_nick == m_nick}">
					 
					<input type="button" value="수정"  class="btn btn-info"
					 onclick="location.href='updatepassform.do?b_seq=${cdto.b_seq}&pageNum=${pageNum}'">
					 <input type="button" value="삭제"  class="btn btn-danger"
					 onclick="location.href='deletepassform.do?b_seq=${cdto.b_seq}&pageNum=${pageNum}'">
					 </c:if>
