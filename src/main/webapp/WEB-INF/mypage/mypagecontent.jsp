...
<%@page import="mypage.model.MypageDao"%>
	...
	<center>
		...
		<b style="color: gray;">${m_nick}</b>
				...
				<td align="center">
					...
					<b style="color: gray;">${dto.m_hp}</b><br>
				...
				<td align="center">
					...
					<b style="color: gray;">${dto.m_email}</b><br>
				...
				<b style="color: gray;">${dto.m_address}</b>
				...
				<%-- <center>	
					  ...
					  <c:set var="ext" value="${fn:substringAfter(im,'.')}"/>
						...
						<c:if test="${ext=='jpg' || ext=='JPG'|| ext=='gif'|| ext=='GIF'
							...
							<img src="${root}/save/${im}" width=100" height="100">
							  	<br><br>		
...
<video width="300" height="200" controls="controls">
       ...
       <img class="img-responsive" src="${root}/save/${im}" width="300" height="200">
			...
			<tr>
			<td align="center">프로필사진(Image)</td>
				<td align="center">
	  ...
	  <%-- 	</c:if> --%>
			...
			<td align="center"><b style="color: gray;">실행</b></td>
				<td align="center"> -->
					...
					<c:if test="${sessionScope.m_id_==dto.m_id}">
					 
					<%--  <c:if test="${sessionScope.m_id_.equals(sessionScope.m_id_)}"> --%>
					 
					 <input type="button" value="수정"  class="btn btn-info btn-sm"
					 onclick="location.href='mypageboardupdatepassform.do?num=${dto.num}&pageNum=${pageNum}'">
					 <input type="button" value="삭제"  class="btn btn-danger btn-sm"
					 onclick="location.href='mypageboarddeletepassform.do?num=${dto.num}&pageNum=${pageNum}'">
					  </c:if>
				<!-- </td>
