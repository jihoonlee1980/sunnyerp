...
<c:if test="${sessionScope.m_id_.equals(sessionScope.m_id_)}">
		...
		<form action="mypageboardupdatepass.do" enctype="multipart/form-data" method="post">
		
		
		
		
		
 		<table id="mypageboardupdatepass" class="table table-bordered">
 	...
 	<!-- 	<table id="file_table" class="table table-bordered"> -->
 		 ...
 		 <tr>
 		 	...
 		 	<td align="center">
 		 		<input type="text" name="m_nick" id="m_nick" required="required" class="form-control"
 		 ...
 		 <tr>
 		 	<td align="center"><b style="color: gray;">패스워드(Password)</b></td>
 		 	<td align="center">
 		 		<input type="text" name="m_pass" id="m_pass" required="required" class="form-control"
 		 		value="${admindto.m_pass}" >
 		 	</td>
 		 </tr>
 		 <tr>
 		 	<td align="center"><b style="color: gray;">회사(Company)</b></td>
 		 	<td align="center">
 		 		<input type="text" name="m_level" id="m_level" required="required" class="form-control"
		...
		<input type="text" name="gender" id="gender" class="form-control" required="required" placeholder="직접입력 또는 성별선택">
 		 ...
 		 <tr>
 		 	...
 		 	<td align="center">
 		 		<input type="text" name="m_hp" id="m_hp" required="required" class="form-control"
 		 		placeholder="-없이,  예 ) 01012345678" value="${admindto.m_hp}">
 		 	</td>
 		 </tr>
 		 <tr>
 		 	<td align="center"><b style="color: gray;">이메일(Email)</b></td>
 		 	<td align="center">
 		 		<input type="text" name="m_email" id="m_email" required="required" class="form-control"
 		 		placeholder="예) sunnyfactory@factorysunny.com" value="${admindto.m_email}">
 		 	</td>
 		 </tr>
 		  ...
 		  <tr>
 		 	...
 		 	<td align="center">
 		 		<input type="text" name="m_address" id="m_address" required="required" class="form-control"
 		 		placeholder="신주소, 도로명 포함  예 ) 광주광역시 광산구 수등로 94번길 31" value="${admindto.m_address}">
 		 	</td>
 		 </tr>
