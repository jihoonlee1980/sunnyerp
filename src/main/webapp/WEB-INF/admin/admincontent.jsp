...
<%@page import="admin.model.AdminDto"%>
<%@page import="admin.model.AdminDao"%>
			...
			<td align="center"><b style="color: gray;">실행</b></td>
				<td align="center"> -->
					...
					<%--  <c:if test="${sessionScope.m_id_.equals(sessionScope.m_id_)}"> --%>
					 ...
					 onclick="location.href='adminboardupdatepassform.do?num=${dto.num}&pageNum=${pageNum}'">
					 <input type="button" value="삭제"  class="btn btn-danger btn-sm"
					 onclick="location.href='adminboarddeletepassform.do?num=${dto.num}&pageNum=${pageNum}'">
					  </c:if>
				<!-- </td>
