        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-5 col-sm-6">
                    ...
                    <p class="lead"><a target="_blank" href="http://sunnyerp.net/">Sunny Erp(써니 이알피) 는!!</a>
                    <br><br>
                    누구나 손쉽게 사용하고, <br>실용성이 있는!<br>현업 사용자가 직접 개발한!!<br><br>
                    중소 기업에 맞는, <br> 최적화  클라우드(Cloud) 서비스!!!<br><br>
                    </p>
                </div>
                <div class="col-lg-5 col-lg-offset-2 col-sm-6">
                    
                    <img class="img-responsive" src="${root}/save/resources/photo/photo1.JPG" alt="">
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-5 col-lg-offset-1 col-sm-push-6  col-sm-6">
                    ...
                    <p class="lead">기존의, <br>ERP와는 다른<br><br><a target="_blank" href="http://sunnyerp.net/">특별함!<br></a>
                    <br>Sunny Erp 만의, <br> 특별함으로 다가갑니다.</p>
                </div><br>
                <div class="col-lg-5 col-sm-pull-6  col-sm-6">
                   <img class="img-responsive" src="${root}/save/resources/img/slide/sunny100.png" alt="">
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-5 col-sm-6">
                    ...
                    <p class="lead"><a target="_blank" href="http://sunnyerp.net/">회사 Homepage 와 클라우드 Erp</a>,<br>
                    <a target="_blank" href="http://sunnyerp.net">안드로이드 App 과 카메라 IoT</a><br><br>모두! 구축해 드리고<br> 
                    	한번에!! 사용하실 수 있습니다.
                    </p>
                </div>
                <br><br>
                <div class="col-lg-5 col-lg-offset-2 col-sm-6">
                    <img class="img-responsive" src="${root}/save/resources/photo/photo3.png" alt="">
                </div>
            </div>
    ...
    <center>
     ...
     <div>
					...
					<center><img class="img-responsive" src="${root}/save/resources/icon/park.png" width="50" height="50" alt=""></center>
						...
						<div><a href="http://www.freepik.com" title="Freepik"><b style="color:gray">Icons made by 
				Freepik from</b></a> <a target="_blank" target="_blank" href="http://www.flaticon.com" title="Flaticon">
