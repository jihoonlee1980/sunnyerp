        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="${root}/save/index.html" class="site_title"><i class="fa fa-paw"></i> <span>SunnyErp</span></a>
            </div>
            ...
            <div class="profile clearfix">
              <div class="profile_pic">
                <img src="${root}/save/images/img.jpg" alt="..." class="img-circle profile_img">
              </div>
                ...
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-home"></i> Home <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="${root}/save/index.html">Dashboard</a></li>
                      <li><a href="${root}/save/index2.html">Dashboard2</a></li>
                      <li><a href="${root}/save/index3.html">Dashboard3</a></li>
                    </ul>
                  </li>
                  <li><a><i class="fa fa-edit"></i> Forms <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="${root}/save/form.html">General Form</a></li>
                      <li><a href="${root}/save/form_advanced.html">Advanced Components</a></li>
                  ...
                  <li><a><i class="fa fa-desktop"></i> UI Elements <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="${root}/save/general_elements.html">General Elements</a></li>
                      <li><a href="${root}/save/media_gallery.html">Media Gallery</a></li>
                  ...
                  <li><a><i class="fa fa-table"></i> Tables <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="${root}/save/tables.html">Tables</a></li>
                      <li><a href="${root}/save/tables_dynamic.html">Table Dynamic</a></li>
                    </ul>
                  </li>
                  <li><a><i class="fa fa-bar-chart-o"></i> Data Presentation <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="${root}/save/chartjs.html">Chart JS</a></li>
                      <li><a href="${root}/save/chartjs2.html">Chart JS2</a></li>
                  ...
                  <li><a><i class="fa fa-clone"></i>Layouts <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="${root}/save/fixed_sidebar.html">Fixed Sidebar</a></li>
                      <li><a href="${root}/save/fixed_footer.html">Fixed Footer</a></li>
                    </ul>
                  </li>
                </ul>
              </div>
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-bug"></i> Additional Pages <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="${root}/save/e_commerce.html">E-commerce</a></li>
                      <li><a href="${root}/save/projects.html">Projects</a></li>
                      <li><a href="${root}/save/project_detail.html">Project Detail</a></li>
                      <li><a href="${root}/save/contacts.html">Contacts</a></li>
                      <li><a href="${root}/save/profile.html">Profile</a></li>
                    </ul>
                  </li>
                  <li><a><i class="fa fa-windows"></i> Extras <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="${root}/save/page_403.html">403 Error</a></li>
                      <li><a href="${root}/save/page_404.html">404 Error</a></li>
                      <li><a href="${root}/save/page_500.html">500 Error</a></li>
                      <li><a href="${root}/save/plain_page.html">Plain Page</a></li>
                      <li><a href="${root}/save/login.html">Login Page</a></li>
                      <li><a href="${root}/save/pricing_tables.html">Pricing Tables</a></li>
                    </ul>
                  </li>
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                    <img src="${root}/save/images/img.jpg" alt="">John Doe
                  ...
                  <ul class="dropdown-menu dropdown-usermenu pull-right">
                    ...
                    <li><a href="${root}/save/login.html"><i class="fa fa-sign-out pull-right"></i> Log Out</a></li>
                  </ul>
                </li>
