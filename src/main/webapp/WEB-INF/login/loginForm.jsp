...
<center>
	...
	<c:if test="${sessionScope.m_id_==null}">
		<form action="login.do" method="post">
			<table id="loginform" class="table table-bordered">
				<caption style="text-align: center;"><a style="color: gray;">[LOGIN]</a></caption><br>
				
				
				<tr>
					<td style="text-align: center;"><b style="color: gray;">COMPANY</b></td>
		 		 	<td>
		 		 		<input type="text" name="m_level" class="form-control" required="required" autofocus="autofocus">
		 		 	</td>
				</tr>
				<tr>
					<td style="text-align: center;"><b style="color: gray;">ID</b></td>
		 		 	<td>
		 		 		<input type="text" name="m_id" class="form-control" required="required" autofocus="autofocus">
		 		 	</td>
				</tr>
				<tr>
					<td style="text-align: center;"><b style="color: gray;">PASSWORD</b></td>
		 		 	<td>
			...
			<input type="submit" class="btn" style="color: black" value="LOGIN">
						<!-- <input type="button" class="btn" style="color: black" value="JOIN" onclick="location.href='joinForm.do'"> -->
	...
	<c:if test="${sessionScope.m_id_!=null}">
	<b style="color: gray;">
	<b style="color: blue;">${sessionScope.m_nick}</b>&nbsp 님! <br>로그인(Login) 되었습니다.</b><br>
	<%-- <b style="color: orange;">Company</b> <b style="color: gray;">:</b> <b style="color: black;">[${sessionScope.m_level}]</b><br>
	<b style="color: orange;">Id</b> <b style="color: gray;">:</b> <b style="color: blue;">${sessionScope.m_id_}</b><br> --%>
	<%-- <b style="color: orange;">Name</b> <b style="color: gray;">:</b> <b style="color: brown;">${sessionScope.m_nick}</b><br>
	 --%>
	<%-- <b style="color: orange;">Profile</b> <b style="color: gray;"></b> 
	<br>
	
	
	<c:if test="${sessionScope.m_profile!='none'}">
    		<img src="${root}/save/profileImage/${sessionScope.m_profile}" style="width: 250px; height: 250px;">
			<br>
    	</c:if>
	
    		<img src="${sessionScope.m_profile}" style="width: 50px; height: 50px;">
			<br> --%>
   <%--  <br><br>
    
    <img class="img-responsive" src="${root}/save/ico/favicon2.png" alt="logo"> --%>
    <br>
	...
	<b style="color: navy;">
	* [SunnyErp] 접속 시, 
	<br>logout 후, 재로그인 해 주세요!!</b><br><br>
	<input type="button" value="logout" style="color: gray" class="btn" onclick="location.href='logout.do'">
	<!-- <input type="button" value="mypage" style="color: gray" class="btn" onclick="location.href='myPageForm.do'"> -->
