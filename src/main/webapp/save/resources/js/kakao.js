/**
 * Kakao Javascript SDK for Kakao Open Platform Service - v1.7.0
 *
...
(function (f) {
  ...
  var define, module, exports;return function e(t, n, r) {
    ...
    }, { "../vendor/CryptoJS.js": 21, "../vendor/easyXDM.js": 22, "./auth.withTalk.js": 5, "./auth.withTalk.poller.js": 6, "./common.js": 8, "./common/everntObserver": 10, "./common/logger": 11, "./util.js": 19 }], 5: [function (require, module, exports) {
      module.exports = function () {
        var _k = require('./common.js');
      ...
      module.exports = function () {
        ...
        return function (msg, detail) {
          setTimeout(function () {
            ...
            new Image().src = _k.URL.stat + "?" + escape(JSON.stringify(param));
          }, 0);
        };
      }();
    ...
    }, { "../util.js": 19, "./KakaoError": 9, "./validate": 13 }], 13: [function (require, module, exports) {
    ...
    }, { "./KakaoError": 9 }], 14: [function (require, module, exports) {
      /*******************
       * Emoticon
       *******************/
      module.exports = function () {
    ...
    }, { "./api.js": 3, "./common/everntObserver": 10, "./util.js": 19 }], 15: [function (require, module, exports) {
      /*******************
       * Link
       *******************/
      module.exports = function () {
        ...
        var KakaoTalkLinkWithTemplate = function KakaoTalkLinkWithTemplate() {
          this.appkey = _k.RUNTIME.appKey;
          this.appver = '1.0';
          this.linkver = '4.0';
          this.template_json = {};
        ...
        Link.createTalkLinkWithTemplate = Link.createTalkLinkButtonWithTemplate = function (settings) {
          settings = _k.processRules(settings, rules.createTalkLinkWithTemplate, 'Link.createTalkLinkWithTemplate');
          ...
          var handler = function handler() {
            buildUrlWithTemplate(settings, 'Link.createTalkLinkWithTemplate');
          };
        ...
        Link.sendTalkLinkWithTemplate = function (settings) {
          var settings = _k.processRules(settings, rules.talkLinkWithTemplate, 'Link.sendTalkLinkWithTemplate');
          return buildUrlWithTemplate(settings, 'Link.sendTalkLinkWithTemplate');
        };
        ...
        rules.createTalkLinkWithTemplate = _.defaults({
          required: { templateId: _.isNumber, container: _.passesOneOf([_.isElement, _.isString]) }
        }, rules.talkLinkWithTemplate);
        ...
        function buildUrlWithTemplate(settings) {
          return Kakao.API.request({
            ...
            var linkWithTemplate = new KakaoTalkLinkWithTemplate();
            linkWithTemplate.extras = _.extend(linkWithTemplate.extras, settings.extras);
            linkWithTemplate.template_json = res.template_msg;
            linkWithTemplate.template_args = settings.templateArgs;
            linkWithTemplate.template_id = settings.templateId;
            var url = linkScheme + '://send?' + _.buildQueryString(linkWithTemplate);
            if (url.length > 10000) {
            ...
            _logger("talklink_4_0_error", e.message || e);
            throw e;
          });
        }
        ...
        function sendLink(url, unsupportedCallback, shouldInstallTalk) {
          ...
          try {
            ...
            setTimeout(function () {
              _logger('send_link_error', e.message || e);
            }, 0);
          }
        }
    ...
    }, { "../vendor/web2app.js": 25, "./common.js": 8, "./common/logger": 11, "./link.obj.js": 16, "./util.js": 19, "./webviewchecker.js": 20 }], 16: [function (require, module, exports) {
      /*******************
       * Link Object
       *******************/
      module.exports = function () {
        ...
        function getStickerObj(setting) {
          return {
            "objtype": "sticker",
            "playwebp": setting.playwebp,
            "last": setting.last,
            "sound": setting.sound,
        ...
        function getFlipperImage(setting) {
          return {
            "objtype": "flipper",
            "width": setting.width,
            "height": setting.height,
            "subs": getSubs(setting.images),
            "effect": setting.effect,
            "disptype": setting.displayType
          };
        }

        function getSubs(images) {
          var subs = new Array();
          for (var key in images) {
            var imageMap = new Object();
            imageMap.objtype = "image";
            imageMap.src = images[key];
            subs.push(imageMap);
          }
          return subs;
        }
    ...
    }, { "./common/KakaoError": 9, "./common/ruleProcess": 12, "./util.js": 19 }], 17: [function (require, module, exports) {
    ...
    }, { "./api.js": 3, "./auth.js": 4, "./common.js": 8, "./emoticon.js": 14, "./link.js": 15, "./story.js": 18, "./util.js": 19 }], 18: [function (require, module, exports) {
      module.exports = function () {
        var Story = {};
