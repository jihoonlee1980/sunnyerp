...
public class companyWriteController {
	...
	@RequestMapping("/company/companywriteform.do")
	public String mysql_form()
	{
		return "/1/company/companywriteform";
	}
	
	@RequestMapping(value="/company/upload.do",method=RequestMethod.POST)
	public String form_read(@ModelAttribute CompanyDto dto,HttpServletRequest request)
	{
