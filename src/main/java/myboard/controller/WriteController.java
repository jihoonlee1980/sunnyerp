...
public class WriteController {
	...
	@RequestMapping("/myboard/writeform.do")
	public String mysql_form()
	{
		return "/1/myboard/writeform";
	}
	
	@RequestMapping(value="/myboard/upload.do",method=RequestMethod.POST)
	public String form_read(@ModelAttribute MyboardDto dto,HttpServletRequest request)
	{
